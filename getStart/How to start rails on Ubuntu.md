```bash
reoh@reoh-Ubuntu:~$ rails new ~/RAILS/HelloApp
      create  
      create  README.md
      create  Rakefile
      create  .ruby-version
      ...
      create  Gemfile
         run  git init from "."
已初始化空的 Git 仓库于 /home/reoh/RAILS/HelloApp/.git/
      create  package.json
      create  app
...
The JavaScript app source directory already exists
       apply  /home/reoh/.rbenv/versions/2.6.5/lib/ruby/gems/2.6.0/gems/webpacker-4.2.2/lib/install/binstubs.rb
  Copying binstubs
       exist    bin
      create    bin/webpack
...
reoh@reoh-Ubuntu:~$ cd ~/RAILS/HelloApp/
reoh@reoh-Ubuntu:~/RAILS/HelloApp$ rails server
=> Booting Puma
...
Use Ctrl-C to stop
Started GET "/" for 127.0.0.1 at 2020-04-04 17:39:49 +0800
   (2.2ms)  SELECT sqlite_version(*)
Processing by Rails::WelcomeController#index as HTML
  Rendering /home/reoh/.rbenv/versions/2.6.5/lib/ruby/gems/2.6.0/gems/railties-6.0.2.2/lib/rails/templates/rails/welcome/index.html.erb
  Rendered /home/reoh/.rbenv/versions/2.6.5/lib/ruby/gems/2.6.0/gems/railties-6.0.2.2/lib/rails/templates/rails/welcome/index.html.erb (Duration: 9.1ms | Allocations: 479)
Completed 200 OK in 21ms (Views: 15.1ms | ActiveRecord: 0.0ms | Allocations: 2800)


^C- Gracefully stopping, waiting for requests to finish
=== puma shutdown: 2020-04-04 17:40:08 +0800 ===
- Goodbye!
Exiting
